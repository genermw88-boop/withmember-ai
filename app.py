        ...
        if not store or not reg or not men:
            ...
            with st.spinner("네이버 상권 데이터 수집 및 소개글을 생성 중입니다... (약 10초 소요)"):
                ...
                if msg == "success":
                    ...
                    3. [본문]: 위에 나열된 [필수 반영 타겟 키워드 10개]를 조사나 어미만 살짝 바꾸어 문장 속에 단 하나도 빠짐없이 100% 자연스럽게 녹여내어 작성하세요. 유사한 단어로 대체하지 말고 적혀있는 키워드 글자 그대로 사용해야 합니다.
                    4. 인스타그램 감성 맛집 블로거처럼 물 흐르듯 자연스럽게 작성하세요.
                    5. 글자 수는 공백 포함 150자 ~ 200자 사이로 넉넉하게 구성하세요.
